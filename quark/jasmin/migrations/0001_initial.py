# Generated by Django 5.0.11 on 2025-05-16 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connector_type', models.CharField(choices=[('MO', 'MO'), ('MT', 'MT')], default='MT', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mo_connectors', models.ManyToManyField(help_text='MO Connectors for the route.', to='jasmin.jasminhttpconnector')),
                ('modified_by', models.ForeignKey(help_text='The user which last modified this item', on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_modifications', to=settings.AUTH_USER_MODEL)),
                ('workspace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='workspace.workspace')),
                ('mt_connectors', models.ManyToManyField(help_text='MT Connectors for the route.', to='jasmin.jasminsmppconnector')),
            ],
            options={
