# Generated by Django 5.0.11 on 2025-04-30 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_addr_npi', models.IntegerField(choices=[(0, 'Unknown'), (1, 'ISDN'), (3, 'Data'), (4, 'Telex'), (6, 'Land Mobile'), (8, 'National'), (9, 'Private'), (10, 'Ermes'), (14, 'Internet'), (18, 'WAP Client ID')], default=1, help_text='Source address NPI')),
                ...
                ('dest_addr_npi', models.IntegerField(choices=[(0, 'Unknown'), (1, 'ISDN'), (3, 'Data'), (4, 'Telex'), (6, 'Land Mobile'), (8, 'National'), (9, 'Private'), (10, 'Ermes'), (14, 'Internet'), (18, 'WAP Client ID')], default=1, help_text='Destination address NPI')),
                ...
                ('address_npi', models.IntegerField(choices=[(0, 'Unknown'), (1, 'ISDN'), (3, 'Data'), (4, 'Telex'), (6, 'Land Mobile'), (8, 'National'), (9, 'Private'), (10, 'Ermes'), (14, 'Internet'), (18, 'WAP Client ID')], default=1, help_text='Bind address NPI')),
                ...
                ('registered_delivery', models.BooleanField(default=False, help_text='Request SMSC delivery receipt')),
